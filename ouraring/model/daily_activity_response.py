...
def lazy_import():
    ...
    globals()['DailyActivityModel'] = DailyActivityModel


class DailyActivityResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([DailyActivityModel],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """DailyActivityResponse - a model defined in OpenAPI
