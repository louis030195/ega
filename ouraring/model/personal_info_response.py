...
class PersonalInfoResponse(ModelNormal):
    ...
    attribute_map = {
        ...
        'biological_sex': 'biological_sex',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PersonalInfoResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            age (int): The user's age. This field is only present if the user consented to the personal access scope. Otherwise, this field will be ```null```.. [optional]  # noqa: E501
            weight (float): The user's weight (in kilograms). This field is only present if the user consented to the personal access scope. Otherwise, this field will be ```null```.. [optional]  # noqa: E501
            height (float): The user's height (in meters). This field is only present if the user consented to the personal access scope. Otherwise, this field will be ```null```.. [optional]  # noqa: E501
            biological_sex (str): The user's biological sex. This field is only present if the user consented to the personal access scope. Otherwise, this field will be ```null```.. [optional]  # noqa: E501
            email (str): The user's e-mail. This field is only present if the user consented to the email access scope. Otherwise, this field will be ```null```.. [optional]  # noqa: E501
        """
