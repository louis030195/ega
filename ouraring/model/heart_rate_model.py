...
class HeartRateModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bpm, source, timestamp, *args, **kwargs):  # noqa: E501
        """HeartRateModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, bpm, source, timestamp, *args, **kwargs):  # noqa: E501
        """HeartRateModel - a model defined in OpenAPI
