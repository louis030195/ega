...
def lazy_import():
    ...
    globals()['HeartRateModel'] = HeartRateModel


class HeartRateResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """HeartRateResponse - a model defined in OpenAPI

        Args:
            data ([HeartRateModel]): Heart Rate Model
