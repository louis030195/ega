...
def lazy_import():
    ...
    globals()['HRTSample'] = HRTSample
    globals()['HRVSample'] = HRVSample
    globals()['Sample'] = Sample


class SessionModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'heart_rate': (HRTSample,),  # noqa: E501
            'heart_rate_variability': (HRVSample,),  # noqa: E501
            'mood': (str,),  # noqa: E501
            'motion_count': (Sample,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'heart_rate_variability': 'heart_rate_variability',  # noqa: E501
        'mood': 'mood',  # noqa: E501
        'motion_count': 'motion_count',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, day, start_datetime, end_datetime, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            heart_rate (HRTSample): [optional]  # noqa: E501
            heart_rate_variability (HRVSample): [optional]  # noqa: E501
            mood (str): The user's selected mood after the session: * ```bad``` * ```worse``` * ```same``` * ```good``` * ```great```. [optional]  # noqa: E501
            motion_count (Sample): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, day, start_datetime, end_datetime, type, *args, **kwargs):  # noqa: E501
        """SessionModel - a model defined in OpenAPI
