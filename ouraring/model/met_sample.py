...
class METSample(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, interval, items, timestamp, *args, **kwargs):  # noqa: E501
        """METSample - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, interval, items, timestamp, *args, **kwargs):  # noqa: E501
        """METSample - a model defined in OpenAPI
