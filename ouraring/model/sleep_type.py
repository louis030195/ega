...
class SleepType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SleepType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Possible sleep period types.., must be one of ["sleep", "long_sleep", "late_nap", "rest", ]  # noqa: E501

        Keyword Args:
            value (str): Possible sleep period types.., must be one of ["sleep", "long_sleep", "late_nap", "rest", ]  # noqa: E501
