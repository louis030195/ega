...
class TagModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, day, timestamp, tags, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            text (str): Custom annotations associated with the tag, as provided by the user. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, day, timestamp, tags, *args, **kwargs):  # noqa: E501
        """TagModel - a model defined in OpenAPI
