...
class ActivityContributors(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'meet_daily_targets': (int,),  # noqa: E501
            'move_every_hour': (int,),  # noqa: E501
            'recovery_time': (int,),  # noqa: E501
            'stay_active': (int,),  # noqa: E501
            'training_frequency': (int,),  # noqa: E501
            'training_volume': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        'meet_daily_targets': 'meet_daily_targets',  # noqa: E501
        'move_every_hour': 'move_every_hour',  # noqa: E501
        'recovery_time': 'recovery_time',  # noqa: E501
        'stay_active': 'stay_active',  # noqa: E501
        'training_frequency': 'training_frequency',  # noqa: E501
        'training_volume': 'training_volume',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ActivityContributors - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            meet_daily_targets (int): Contribution of meeting previous 7-day daily activity targets in range ```[1, 100]```. [optional]  # noqa: E501
            move_every_hour (int): Contribution of previous 24-hour inactivity alerts in range ```[1, 100]```. [optional]  # noqa: E501
            recovery_time (int): Contribution of previous 7-day recovery time in range ```[1, 100]```. [optional]  # noqa: E501
            stay_active (int): Contribution of previous 24-hour activity in range ```[1, 100]```. [optional]  # noqa: E501
            training_frequency (int): Contribution of previous 7-day exercise frequency in range ```[1, 100]```. [optional]  # noqa: E501
            training_volume (int): Contribution of previous 7-day exercise volume in range ```[1, 100]```. [optional]  # noqa: E501
        """
