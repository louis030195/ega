...
class DailyActivityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.daily_activity_route_daily_activity_get_endpoint = _Endpoint(
            settings={
                'response_type': (DailyActivityResponse,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/daily_activity',
                'operation_id': 'daily_activity_route_daily_activity_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def daily_activity_route_daily_activity_get(
        self,
        **kwargs
    ):
        """Get Daily Activity  # noqa: E501

        Returns Oura Daily Activity data for the specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.daily_activity_route_daily_activity_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.daily_activity_route_daily_activity_get_endpoint.call_with_http_info(**kwargs)
