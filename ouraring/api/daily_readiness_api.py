...
class DailyReadinessApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.daily_readiness_route_daily_readiness_get_endpoint = _Endpoint(
            settings={
                'response_type': (DailyReadiness,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/daily_readiness',
                'operation_id': 'daily_readiness_route_daily_readiness_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def daily_readiness_route_daily_readiness_get(
        self,
        **kwargs
    ):
        """Get Daily Readiness  # noqa: E501

        Returns Oura Daily Readiness data for the specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.daily_readiness_route_daily_readiness_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.daily_readiness_route_daily_readiness_get_endpoint.call_with_http_info(**kwargs)
