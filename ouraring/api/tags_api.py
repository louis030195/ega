...
class TagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.tags_route_tag_get_endpoint = _Endpoint(
            settings={
                'response_type': (TagResponse,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/tag',
                'operation_id': 'tags_route_tag_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def tags_route_tag_get(
        self,
        **kwargs
    ):
        """Get Tags  # noqa: E501

        Returns Oura tags data for the specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tags_route_tag_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.tags_route_tag_get_endpoint.call_with_http_info(**kwargs)
