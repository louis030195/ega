...
class PersonalInfoApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.personal_info_route_get_endpoint = _Endpoint(
            settings={
                'response_type': (PersonalInfoResponse,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/personal_info',
                'operation_id': 'personal_info_route_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def personal_info_route_get(
        self,
        **kwargs
    ):
        """Get Personal Info  # noqa: E501

        Returns personal info data for the specified Oura user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.personal_info_route_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.personal_info_route_get_endpoint.call_with_http_info(**kwargs)
