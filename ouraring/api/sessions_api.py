...
class SessionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.sessions_route_session_get_endpoint = _Endpoint(
            settings={
                'response_type': (SessionResponse,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/session',
                'operation_id': 'sessions_route_session_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def sessions_route_session_get(
        self,
        **kwargs
    ):
        """Get Sessions  # noqa: E501

        Returns available Oura session data for the specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sessions_route_session_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.sessions_route_session_get_endpoint.call_with_http_info(**kwargs)
