...
class DailySleepApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.daily_sleep_route_daily_sleep_get_endpoint = _Endpoint(
            settings={
                'response_type': (DailySleep,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/daily_sleep',
                'operation_id': 'daily_sleep_route_daily_sleep_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def daily_sleep_route_daily_sleep_get(
        self,
        **kwargs
    ):
        """Get Daily Sleep  # noqa: E501

        Returns Oura Daily Sleep data for the specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.daily_sleep_route_daily_sleep_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.daily_sleep_route_daily_sleep_get_endpoint.call_with_http_info(**kwargs)
