...
class SleepPeriodsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.sleep_route_sleep_get_endpoint = _Endpoint(
            settings={
                'response_type': (SleepModel,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/sleep',
                'operation_id': 'sleep_route_sleep_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def sleep_route_sleep_get(
        self,
        **kwargs
    ):
        """Get Sleep Periods  # noqa: E501

        Returns available Oura sleep data for the specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sleep_route_sleep_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.sleep_route_sleep_get_endpoint.call_with_http_info(**kwargs)
