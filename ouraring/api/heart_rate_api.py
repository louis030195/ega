...
class HeartRateApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.heartrate_route_heartrate_get_endpoint = _Endpoint(
            settings={
                'response_type': (HeartRateResponse,),
                'auth': [],
                'endpoint_path': '/v2/usercollection/heartrate',
                'operation_id': 'heartrate_route_heartrate_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def heartrate_route_heartrate_get(
        self,
        **kwargs
    ):
        """Get Heart Rate  # noqa: E501

        Returns available heart rate data for a specified Oura user within a given timeframe  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.heartrate_route_heartrate_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.heartrate_route_heartrate_get_endpoint.call_with_http_info(**kwargs)
