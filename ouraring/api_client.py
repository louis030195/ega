...
from ouraring import rest
from ouraring.configuration import Configuration
from ouraring.exceptions import ApiTypeError, ApiValueError, ApiException
from ouraring.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DailyActivityApi()
        api_instance.daily_activity_route_daily_activity_get  # this is an instance of the class Endpoint
        api_instance.daily_activity_route_daily_activity_get()  # this invokes api_instance.daily_activity_route_daily_activity_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.daily_activity_route_daily_activity_get.callable or self.callable in this class
