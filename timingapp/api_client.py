...
from timingapp import rest
from timingapp.configuration import Configuration
from timingapp.exceptions import ApiTypeError, ApiValueError, ApiException
from timingapp.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.api_v1_projects_get  # this is an instance of the class Endpoint
        api_instance.api_v1_projects_get()  # this invokes api_instance.api_v1_projects_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_v1_projects_get.callable or self.callable in this class
